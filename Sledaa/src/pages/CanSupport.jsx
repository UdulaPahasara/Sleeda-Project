      ...
      <Box sx={{
        ...
        <Box sx={{ 
          ...
          <Typography sx={{
            ...
            Share your knowledge, experience, and professional network to help newly arrived Sri Lankan engineering diplomates successfully settle, grow, and thrive in Australia.
          </Typography>
        </Box>
      </Box>
